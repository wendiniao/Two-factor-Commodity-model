...
implied_vol=np.array([0.39,0.39,0.39,0.39,0.40,0.41]).reshape((1,len_maturity))
...
#correlation item of short term and long term
...
#use the parameter to run Kalman filter
...
# compare model output with actual forward    
for i in range(1,15):
